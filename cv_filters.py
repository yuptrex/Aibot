...
# ---------------------------------------------------------------------------
# Mask registry: every fittable mask overlay, split into two categories via
# the "category" field ("eye" = domino-style eye masks, "face" = full-face
# masks). Each asset is centered on its own 900x700 canvas with its own
# measured eye-anchor pair, used to scale/rotate/position the mask onto the
# detected face regardless of category. Key = mask id used in callback_data.
# ---------------------------------------------------------------------------
MASKS = {
    "cyber_visor": {
        "label": "👁️ Cyber Visor",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "cyber_visor.png"),
        "preview": os.path.join(_ASSETS_DIR, "cyber_visor_preview.jpg"),
        "left_eye": (306, 358),
        "right_eye": (595, 358),
    },
    "kitsune_spirit": {
        "label": "👁️ Kitsune Spirit",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "kitsune_spirit.png"),
        "preview": os.path.join(_ASSETS_DIR, "kitsune_spirit_preview.jpg"),
        "left_eye": (313, 445),
        "right_eye": (586, 447),
    },
    "void_wraith": {
        "label": "👁️ Void Wraith",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "void_wraith.png"),
        "preview": os.path.join(_ASSETS_DIR, "void_wraith_preview.jpg"),
        "left_eye": (318, 396),
        "right_eye": (582, 395),
    },
    "glacier_shard": {
        "label": "👁️ Glacier Shard",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "glacier_shard.png"),
        "preview": os.path.join(_ASSETS_DIR, "glacier_shard_preview.jpg"),
        "left_eye": (342, 396),
        "right_eye": (593, 397),
    },
    "toxic_viper": {
        "label": "👁️ Toxic Viper",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "toxic_viper.png"),
        "preview": os.path.join(_ASSETS_DIR, "toxic_viper_preview.jpg"),
        "left_eye": (322, 400),
        "right_eye": (581, 400),
    },
    "lunar_eclipse": {
        "label": "👁️ Lunar Eclipse",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "lunar_eclipse.png"),
        "preview": os.path.join(_ASSETS_DIR, "lunar_eclipse_preview.jpg"),
        "left_eye": (316, 384),
        "right_eye": (586, 385),
    },
    "coral_bloom": {
        "label": "👁️ Coral Bloom",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "coral_bloom.png"),
        "preview": os.path.join(_ASSETS_DIR, "coral_bloom_preview.jpg"),
        "left_eye": (322, 387),
        "right_eye": (582, 386),
    },
    "amber_talon": {
        "label": "👁️ Amber Talon",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "amber_talon.png"),
        "preview": os.path.join(_ASSETS_DIR, "amber_talon_preview.jpg"),
        "left_eye": (329, 391),
        "right_eye": (577, 391),
    },
    "wildwood": {
        "label": "👁️ Wildwood",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "wildwood.png"),
        "preview": os.path.join(_ASSETS_DIR, "wildwood_preview.jpg"),
        "left_eye": (334, 417),
        "right_eye": (580, 417),
    },
    "crimson_fang": {
        "label": "👁️ Crimson Fang",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "crimson_fang.png"),
        "preview": os.path.join(_ASSETS_DIR, "crimson_fang_preview.jpg"),
        "left_eye": (326, 416),
        "right_eye": (580, 414),
    },
    "iron_spike": {
        "label": "👁️ Iron Spike",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "iron_spike.png"),
        "preview": os.path.join(_ASSETS_DIR, "iron_spike_preview.jpg"),
        "left_eye": (324, 392),
        "right_eye": (575, 391),
    },
    "boneyard": {
        "label": "👁️ Boneyard",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "boneyard.png"),
        "preview": os.path.join(_ASSETS_DIR, "boneyard_preview.jpg"),
        "left_eye": (309, 396),
        "right_eye": (590, 396),
    },
    "steel_falcon": {
        "label": "👁️ Steel Falcon",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "steel_falcon.png"),
        "preview": os.path.join(_ASSETS_DIR, "steel_falcon_preview.jpg"),
        "left_eye": (331, 417),
        "right_eye": (573, 416),
    },
    "golden_hawk": {
        "label": "👁️ Golden Hawk",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "golden_hawk.png"),
        "preview": os.path.join(_ASSETS_DIR, "golden_hawk_preview.jpg"),
        "left_eye": (307, 430),
        "right_eye": (592, 432),
    },
    "brass_goggles": {
        "label": "👁️ Brass Goggles",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "brass_goggles.png"),
        "preview": os.path.join(_ASSETS_DIR, "brass_goggles_preview.jpg"),
        "left_eye": (314, 418),
        "right_eye": (591, 416),
    },
    "ember_wing": {
        "label": "👁️ Ember Wing",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "ember_wing.png"),
        "preview": os.path.join(_ASSETS_DIR, "ember_wing_preview.jpg"),
        "left_eye": (323, 405),
        "right_eye": (577, 404),
    },
    "storm_volt": {
        "label": "👁️ Storm Volt",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "storm_volt.png"),
        "preview": os.path.join(_ASSETS_DIR, "storm_volt_preview.jpg"),
        "left_eye": (312, 375),
        "right_eye": (587, 375),
    },
    "camo_ranger": {
        "label": "👁️ Camo Ranger",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "camo_ranger.png"),
        "preview": os.path.join(_ASSETS_DIR, "camo_ranger_preview.jpg"),
        "left_eye": (309, 365),
        "right_eye": (590, 366),
    },
    "blood_kitsune": {
        "label": "👁️ Blood Kitsune",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "blood_kitsune.png"),
        "preview": os.path.join(_ASSETS_DIR, "blood_kitsune_preview.jpg"),
        "left_eye": (310, 380),
        "right_eye": (586, 380),
    },
    "frostbolt": {
        "label": "👁️ Frostbolt",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "frostbolt.png"),
        "preview": os.path.join(_ASSETS_DIR, "frostbolt_preview.jpg"),
        "left_eye": (312, 379),
        "right_eye": (594, 378),
    },
    "circuit_white": {
        "label": "👁️ Circuit White",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "circuit_white.png"),
        "preview": os.path.join(_ASSETS_DIR, "circuit_white_preview.jpg"),
        "left_eye": (315, 366),
        "right_eye": (585, 366),
    },
    "raven_feather": {
        "label": "👁️ Raven Feather",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "raven_feather.png"),
        "preview": os.path.join(_ASSETS_DIR, "raven_feather_preview.jpg"),
        "left_eye": (324, 399),
        "right_eye": (580, 398),
    },
    "scarlet_blade": {
        "label": "👁️ Scarlet Blade",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "scarlet_blade.png"),
        "preview": os.path.join(_ASSETS_DIR, "scarlet_blade_preview.jpg"),
        "left_eye": (305, 381),
        "right_eye": (592, 382),
    },
    "weathered_hide": {
        "label": "👁️ Weathered Hide",
        "category": "eye",
        "file": os.path.join(_ASSETS_DIR, "weathered_hide.png"),
        "preview": os.path.join(_ASSETS_DIR, "weathered_hide_preview.jpg"),
        "left_eye": (309, 374),
        "right_eye": (589, 373),
    },
    "onyx_trooper": {
        "label": "🎭 Onyx Trooper",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "onyx_trooper.png"),
        "preview": os.path.join(_ASSETS_DIR, "onyx_trooper_preview.jpg"),
        "left_eye": (382, 385),
        "right_eye": (517, 384),
    },
    "crimson_kitsune": {
        "label": "🎭 Crimson Kitsune",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "crimson_kitsune.png"),
        "preview": os.path.join(_ASSETS_DIR, "crimson_kitsune_preview.jpg"),
        "left_eye": (388, 381),
        "right_eye": (517, 380),
    },
    "shadow_cowl": {
        "label": "🎭 Shadow Cowl",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "shadow_cowl.png"),
        "preview": os.path.join(_ASSETS_DIR, "shadow_cowl_preview.jpg"),
        "left_eye": (393, 535),
        "right_eye": (505, 536),
    },
    "frost_sentinel": {
        ...
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "frost_sentinel.png"),
        "preview": os.path.join(_ASSETS_DIR, "frost_sentinel_preview.jpg"),
        "left_eye": (371, 379),
        "right_eye": (528, 383),
    },
    "inferno_devil": {
        "label": "🎭 Inferno Devil",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "inferno_devil.png"),
        "preview": os.path.join(_ASSETS_DIR, "inferno_devil_preview.jpg"),
        "left_eye": (385, 385),
        "right_eye": (513, 385),
    },
    "gilded_warden": {
        "label": "🎭 Gilded Warden",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "gilded_warden.png"),
        "preview": os.path.join(_ASSETS_DIR, "gilded_warden_preview.jpg"),
        "left_eye": (379, 374),
        "right_eye": (523, 373),
    },
    "toxic_reaper": {
        "label": "🎭 Toxic Reaper",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "toxic_reaper.png"),
        "preview": os.path.join(_ASSETS_DIR, "toxic_reaper_preview.jpg"),
        "left_eye": (381, 367),
        "right_eye": (520, 366),
    },
    "amethyst_ghoul": {
        "label": "🎭 Amethyst Ghoul",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "amethyst_ghoul.png"),
        "preview": os.path.join(_ASSETS_DIR, "amethyst_ghoul_preview.jpg"),
        "left_eye": (385, 375),
        "right_eye": (520, 373),
    },
    "cracked_marble": {
        "label": "🎭 Cracked Marble",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "cracked_marble.png"),
        "preview": os.path.join(_ASSETS_DIR, "cracked_marble_preview.jpg"),
        "left_eye": (383, 369),
        "right_eye": (513, 370),
    },
    "midnight_crescent": {
        "label": "🎭 Midnight Crescent",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "midnight_crescent.png"),
        "preview": os.path.join(_ASSETS_DIR, "midnight_crescent_preview.jpg"),
        "left_eye": (381, 374),
        "right_eye": (522, 373),
    },
    "scarlet_bolt": {
        "label": "🎭 Scarlet Bolt",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "scarlet_bolt.png"),
        "preview": os.path.join(_ASSETS_DIR, "scarlet_bolt_preview.jpg"),
        "left_eye": (381, 367),
        "right_eye": (521, 364),
    },
    "grim_skull": {
        "label": "🎭 Grim Skull",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "grim_skull.png"),
        "preview": os.path.join(_ASSETS_DIR, "grim_skull_preview.jpg"),
        "left_eye": (384, 360),
        "right_eye": (518, 360),
    },
    "magma_reaper": {
        "label": "🎭 Magma Reaper",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "magma_reaper.png"),
        "preview": os.path.join(_ASSETS_DIR, "magma_reaper_preview.jpg"),
        "left_eye": (381, 366),
        "right_eye": (516, 365),
    },
    "verdant_guardian": {
        "label": "🎭 Verdant Guardian",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "verdant_guardian.png"),
        "preview": os.path.join(_ASSETS_DIR, "verdant_guardian_preview.jpg"),
        "left_eye": (383, 369),
        "right_eye": (517, 368),
    },
    "diamond_jester": {
        "label": "🎭 Diamond Jester",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "diamond_jester.png"),
        "preview": os.path.join(_ASSETS_DIR, "diamond_jester_preview.jpg"),
        "left_eye": (381, 367),
        "right_eye": (516, 366),
    },
    "fractured_onyx": {
        "label": "🎭 Fractured Onyx",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "fractured_onyx.png"),
        "preview": os.path.join(_ASSETS_DIR, "fractured_onyx_preview.jpg"),
        "left_eye": (385, 365),
        "right_eye": (514, 363),
    },
    "cyber_wraith": {
        "label": "🎭 Cyber Wraith",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "cyber_wraith.png"),
        "preview": os.path.join(_ASSETS_DIR, "cyber_wraith_preview.jpg"),
        "left_eye": (384, 369),
        "right_eye": (515, 370),
    },
    "ice_crown": {
        "label": "🎭 Ice Crown",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "ice_crown.png"),
        "preview": os.path.join(_ASSETS_DIR, "ice_crown_preview.jpg"),
        "left_eye": (381, 368),
        "right_eye": (518, 369),
    },
    "oni_blaze": {
        "label": "🎭 Oni Blaze",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "oni_blaze.png"),
        "preview": os.path.join(_ASSETS_DIR, "oni_blaze_preview.jpg"),
        "left_eye": (382, 368),
        "right_eye": (519, 368),
    },
    "neon_phantom": {
        "label": "🎭 Neon Phantom",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "neon_phantom.png"),
        "preview": os.path.join(_ASSETS_DIR, "neon_phantom_preview.jpg"),
        "left_eye": (378, 367),
        "right_eye": (521, 367),
    },
    "raven_beak": {
        "label": "🎭 Raven Beak",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "raven_beak.png"),
        "preview": os.path.join(_ASSETS_DIR, "raven_beak_preview.jpg"),
        "left_eye": (375, 328),
        "right_eye": (525, 326),
    },
    "violet_circuit": {
        ...
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "violet_circuit.png"),
        "preview": os.path.join(_ASSETS_DIR, "violet_circuit_preview.jpg"),
        "left_eye": (384, 358),
        "right_eye": (519, 356),
    },
    "golden_sigil": {
        "label": "🎭 Golden Sigil",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "golden_sigil.png"),
        "preview": os.path.join(_ASSETS_DIR, "golden_sigil_preview.jpg"),
        "left_eye": (382, 357),
        "right_eye": (520, 356),
    },
    "fractured_soul": {
        "label": "🎭 Fractured Soul",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "fractured_soul.png"),
        "preview": os.path.join(_ASSETS_DIR, "fractured_soul_preview.jpg"),
        "left_eye": (382, 349),
        "right_eye": (518, 349),
    },
    "steampunk_gasmask": {
        "label": "🎭 Steampunk Gasmask",
        "category": "face",
        "file": os.path.join(_ASSETS_DIR, "steampunk_gasmask.png"),
        "preview": os.path.join(_ASSETS_DIR, "steampunk_gasmask_preview.jpg"),
        "left_eye": (366, 343),
        "right_eye": (533, 343),
    },
}
...
def tech_visor_bw(image_bytes: bytes) -> bytes:
    """Kept for backward compatibility -- quick-access style button now
    points at the closest replacement in the new mask set."""
    return apply_mask_by_id(image_bytes, "cyber_visor")
